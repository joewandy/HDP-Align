...
//				HeaderPrinter.printHeader(application, version);
...
//				HeaderPrinter.printHeader(application, version);
			...
			PeakMLToMzMineWriter.write(prefix, result.header, peakset.getPeaks(), null, output, null);
