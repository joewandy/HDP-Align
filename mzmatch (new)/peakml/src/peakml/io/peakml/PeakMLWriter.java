...
public class PeakMLWriter
{
	...
	public static void write(Header header, Vector<? extends IPeak> peaks, WriterProgressListener listener, OutputStream out, String stylesheet) throws IOException
	{
		if (header != null)
