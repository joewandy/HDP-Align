...
import mzmatch.ipeak.util.NewMassSpectrum;
...
public class ExtractIsotopePatterns
{
	...
	public static void main(String args[])
	{
		try
		{
			...
			//writer.writeRecord(new String[]{ "Name", "Formula", "Distribution", "Masses", "Adducts", "Isotopes" });
			OutputStreamWriter writer = new OutputStreamWriter(output);
			writer.write("Name\tFormula\tDistribution\tMasses\tAdducts\tIsotopes\n");
			...
			for (Molecule molecule : molecules.values()) {
				...
				line.add(molecule.getName());
				line.add(formula.toString());
				...
				//writer.write(Common.join(ms.getDistribution(), " "));
				//writer.write(Common.join(ms.getMasses(), " "));
				line.add(Common.join(ms.getDistribution(), " "));
				line.add(Common.join(ms.getMasses(), " "));
				...
				//writer.write(Common.join(msAdducts, " "));
				//writer.write(Common.join(ms.getGeneralMolecularFormulas(), " "));
				line.add(Common.join(msAdducts, " "));
				line.add(Common.join(ms.getGeneralMolecularFormulas(), " "));
				
				
				//writer.endRecord();
				//System.err.println(ms.toString());
				//writer.flush();
				writer.write(Common.join(line, "\t"));
				writer.write("\n");
