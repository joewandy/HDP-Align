...
public class IXRawfile
{
	...
	public String getErrorMessage() throws IXRawfileException
	{
		...
		int pointer = OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
	...
	public Controller getCurrentController() throws IXRawfileException
	{
		...
		// allocate memory for the return-value(s)
		int pointer_type = OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
		int pointer_number = OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
	...
	public String[] getFilters() throws IXRawfileException
	{
		...
		// allocate memory for the return-value(s)
		int pointer_array = OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
		int pointer_size = OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
	...
	public double[] getMassListFromScanNum(int scannumber, boolean centroid) throws IXRawfileException
	{
		...
		// allocate memory for the return-value(s)
		int pointer_scannumber = OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
		int pointer_masslist   = OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
		int pointer_peakflags  = OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
		int pointer_arraysize  = OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
	...
	public PrecursorInfo[] getPrecursorInfoFromScanNum(int scannumber) throws IXRawfileException
	{
		...
		// allocate memory for the return-value(s)
		int pointer_infos = OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
		int pointer_size = OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
	...
	public Vector<Noise> getNoiseData(int scannumber) throws IXRawfileException
	{
		...
		// allocate memory for the return-value(s)
		int pointer_packets = OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
		int pointer_scannumber = OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
	...
	public ScanHeaderInfo getScanHeaderInfoForScanNum(int scannumber) throws IXRawfileException
	{
		...
		// allocate memory for the return-value(s)
		int pointer_numpackets			= OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
		int pointer_starttime			= OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
		int pointer_lowmass				= OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
		int pointer_highmass			= OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
		int pointer_tic					= OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
		int pointer_basepeakmass		= OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
		int pointer_basepeakintensity	= OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
		int pointer_numchannels			= OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
		int pointer_uniformtime			= OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
		int pointer_frequency			= OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
	...
	public HashMap<String,String> getStatusLogForScanNum(int scannumber) throws IXRawfileException
	{
		...
		// allocate memory for the return-value(s)
		int pointer_rt					= OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
		int pointer_labels				= OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
		int pointer_values				= OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
		int pointer_size				= OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
	...
	public String getStatusLogValueForScanNum(int scannumber, String label) throws IXRawfileException
	{
		...
		// allocate memory for the return-value(s)
		int pointer_rt = OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
		int pointer_value = OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
	...
	public String getErrorLogItem(int itemnumber) throws IXRawfileException
	{
		...
		// allocate memory for the return-value(s)
		int pointer_rt				= OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
		int pointer_error			= OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
	...
	public Vector<Label> getLabelData(int scannumber) throws IXRawfileException
	{
		...
		// allocate memory for the return-value(s)
		int ptr_labels = OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
		int ptr_flags = OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
		int ptr_scannumber = OS.GlobalAlloc(OS.GMEM_FIXED|OS.GMEM_ZEROINIT, Variant.sizeof);
