...
import com.apporiented.algorithm.clustering.test.SampleClusterData;
...
public class DefaultClusteringAlgorithm implements ClusteringAlgorithm {
	...
	public static void main(String[] args) {
        ...
        Cluster cluster = alg.performClustering(SampleClusterData.DISTANCES, SampleClusterData.NAMES,
                new CompleteLinkageStrategy());
        String output = cluster.traverse(4);
