...
public class TripletLibraryBuilder implements Runnable {
	...
	public TripletLibraryBuilder(BlockingQueue<ExtendedLibrary> queue, 
	...
	private ExtendedLibrary produceTripletLibrary() {
		...
		ExtendedLibrary result = new ExtendedLibrary();
