...
public class IntervalTree<Type> {
	...
	public static void main(String args[]) {
		...
		it.addInterval(0, 10, "s1");
		it.addInterval(20, 30, "s2");
		it.addInterval(15, 17, "s3");
		it.addInterval(25, 35, "s4");
		 
		List<String> result1 = it.get(5);
		List<String> result2 = it.get(10);
		List<String> result3 = it.get(29);
		List<String> result4 = it.get(5, 15);
