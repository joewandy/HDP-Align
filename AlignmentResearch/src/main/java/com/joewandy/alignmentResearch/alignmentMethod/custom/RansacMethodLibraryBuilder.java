...
public class RansacMethodLibraryBuilder extends PairwiseLibraryBuilderImpl implements Runnable, PairwiseLibraryBuilder {

	public RansacMethodLibraryBuilder(BlockingQueue<AlignmentLibrary> queue,
	...
	protected AlignmentMethod getAlignmentMethod(List<AlignmentFile> files,
		...
		AlignmentMethod pairwiseAligner = new MzMineRansacAlignment(files, param);
