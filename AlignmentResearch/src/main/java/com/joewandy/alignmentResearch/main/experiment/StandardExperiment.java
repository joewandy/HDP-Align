...
public class StandardExperiment extends MultiAlignBaseExp implements
	...
	public static final double[] ALL_MIN_CORR = { 0.70, 0.75, 0.80, 0.85, 0.90,
			0.95 };
...
//	public static final double[] ALL_ALIGNMENT_RT = { 85, 90, 95, 100 };	
	...
	public List<MultiAlignExpResult> performExperiment(
		...
		System.out.println("Experiment Type = Metabolomic");
					...
					for (int k = 0; k < groupingRts.length; k++) {
						for (int j = 0; j < alphas.length; j++) {
							for (int l = 0; l < minCorrs.length; l++) {
								...
								System.out.println();
								System.out.println("--- alignmentMz = "
										+ alignmentMz + " alignmentRt = "
										+ alignmentRt + " groupingRt = "
										+ groupingRts[k] + " minCorrSignal = "
										+ minCorrs[l] + " alpha = " + alphas[j]
										+ " ---");
								System.out.println();
		...
		if (bestResult != null) {
			...
			System.out.println("--- alignmentMz = " + bestMz
					...
					+ bestGroupingRtWindow + " minCorrSignal = "
					+ bestMinCorrSignal + " alpha = " + bestAlpha + " ---");
			System.out.println();
