...
public class CustomDBSearchParameters extends SimpleParameterSet {
	...
	public static final FileNameParameter extraDataBaseFile = new FileNameParameter(
			"Extra Database file",
			"Name of file that contains additional 'noisy' records for peak identification evaluation");
	
	public static final IntegerParameter extraLimit = new IntegerParameter(
			"Extra Database Limit",
			"Maximum number of additional 'noise' records inserted",
			200);
	...
	public CustomDBSearchParameters() {
		super(new Parameter[] { peakLists, dataBaseFile, extraDataBaseFile, extraLimit, fieldSeparator,
