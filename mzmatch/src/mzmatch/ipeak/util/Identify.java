	...
	public static void main(String args[])
	{
		try
		{
			...
			for (Molecule molecule : molecules.values())
			{
				...
				//double moleculeMass = molecule.getMass(Mass.MONOISOTOPIC, options.massOverride);
					...
					for (IPeak peak : neighbourhood)
					{
						...
						if (idAnnotation != null)
						{
							...
							if (add == true) {
								...
								peak.addAnnotation(Annotation.adduct, adductAnnotation.getValue() + ", " + adducts[adductIndex]);
							...
							peak.addAnnotation(Annotation.adduct, adducts[adductIndex]);
