...
public class Combine {
	...
	@OptionsClass(name = application, version = version, author = "RA Scheltema (r.a.scheltema@rug.nl)", description = "Combines the contents of a set of PeakML files, containing either mass chromatograms "
	...
	public static class Options {
		@Option(name = "i", param = "filename", type = Option.Type.REQUIRED_ARGUMENT, level = Option.Level.USER, usage = "Option for the input files. Multiple files can be passed by separating them "
		...
		@Option(name = "o", param = "filename", type = Option.Type.REQUIRED_ARGUMENT, level = Option.Level.USER, usage = "Option for the ouput file. The resulting matches are written to this file in the "
				+ "PeakML file format."
				+ "\n"
		...
		@Option(name = "label", param = "filename", type = Option.Type.REQUIRED_ARGUMENT, level = Option.Level.USER, usage = "Optional label for the set being made. The labels are stored in the header "
				+ "of the resulting file and used for display purposes.")
		public String label = null;

		@Option(name = "labels", param = "filename", type = Option.Type.REQUIRED_ARGUMENT, level = Option.Level.USER, usage = "Optional labels for the input files. When these are used make sure to give "
				+ "as many labels as there are input files. The labels are stored in the header "
				+ "of the resulting file and used for display purposes.")
		public Vector<String> labels = new Vector<String>();

		@Option(name = "ppm", param = "double", type = Option.Type.REQUIRED_ARGUMENT, level = Option.Level.USER, usage = "The accuracy of the measurement in parts-per-milion. This value is used for the "
		...
		@Option(name = "rtwindow", param = "double", type = Option.Type.REQUIRED_ARGUMENT, level = Option.Level.USER, usage = "The retention time window in seconds, defining the range where to look for matches.")
		public double rtwindow = -1;
		
		@Option(name = "combination", param = "see description", type = Option.Type.REQUIRED_ARGUMENT, level = Option.Level.USER, usage = "- set\n"
		...
		@Option(name = "method", param = "string", type = Option.Type.REQUIRED_ARGUMENT, level = Option.Level.USER, usage = "Which method to use to perform the clustering of related peaksets. Valid options are greedy and sample.")
		public String method = "greedy";

		@Option(name = "measure", param = "string", type = Option.Type.REQUIRED_ARGUMENT, level = Option.Level.USER, usage = "The measure of correlations between peaks. Valid options are pearson and cosine.")
		public String measure = "pearson";

		@Option(name = "p1", param = "float", type = Option.Type.REQUIRED_ARGUMENT, level = Option.Level.USER, usage = "Parameter for mixture model clustering.")
		public double p1 = 0.001f;

		@Option(name = "p0", param = "float", type = Option.Type.REQUIRED_ARGUMENT, level = Option.Level.USER, usage = "Parameter for mixture model clustering.")
		public double p0 = 0.97f;

		@Option(name = "alpha", param = "float", type = Option.Type.REQUIRED_ARGUMENT, level = Option.Level.USER, usage = "Parameter for mixture model clustering.")
		public double alpha = 1.0f;

		@Option(name = "alpha0", param = "float", type = Option.Type.REQUIRED_ARGUMENT, level = Option.Level.USER, usage = "Parameter for BetaBeta mixture model clustering.")
		public float alpha0 = 2.0f;

		@Option(name = "alpha1", param = "float", type = Option.Type.REQUIRED_ARGUMENT, level = Option.Level.USER, usage = "Parameter for BetaBeta mixture model clustering.")
		public float alpha1 = 10.0f;

		@Option(name = "numSamples", param = "int", type = Option.Type.REQUIRED_ARGUMENT, level = Option.Level.USER, usage = "Parameter for mixture model clustering.")
		public int numSamples = 20;

		@Option(name = "initialNumClusters", param = "int", type = Option.Type.REQUIRED_ARGUMENT, level = Option.Level.USER, usage = "Parameter for mixture model clustering.")
		public int initialNumClusters = 10;

		@Option(name = "compoundDatabases", param = "int", type = Option.Type.REQUIRED_ARGUMENT, level = Option.Level.USER, usage = "Parameter for optional compound database to match against during mixture model clustering.")
		public Vector<String> compoundDatabases = new Vector<String>();

		@Option(name = "seed", param = "long", type = Option.Type.REQUIRED_ARGUMENT, level = Option.Level.USER, usage = "Parameter for mixture model clustering.")
		public long seed = -1;
	...
	public static void main(String args[]) {
		try {
			...
			if (!"greedy".equals(options.method)
					&& !"sample".equals(options.method)
					&& !"filter".equals(options.method)
					&& !"graph".equals(options.method)) {
				System.err
						.println("[ERROR]: valid options for method are 'greedy', 'sample', 'graph' or 'filter'.");
				System.exit(1);
			}
			...
			} else if ("sima".equals(options.method)) {

			} else if ("sm".equals(options.method)) {
