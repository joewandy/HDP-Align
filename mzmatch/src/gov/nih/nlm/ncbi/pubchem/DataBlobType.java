...
public class DataBlobType  implements java.io.Serializable {
    ...
    private gov.nih.nlm.ncbi.pubchem.BlobFormatType blobFormat;

    private gov.nih.nlm.ncbi.pubchem.CompressType eCompress;
    ...
    public DataBlobType(
           byte[] data,
           gov.nih.nlm.ncbi.pubchem.BlobFormatType blobFormat,
           gov.nih.nlm.ncbi.pubchem.CompressType eCompress) {
           this.data = data;
     ...
     * @return blobFormat
     */
    public gov.nih.nlm.ncbi.pubchem.BlobFormatType getBlobFormat() {
        return blobFormat;
    }
     ...
     * @param blobFormat
     */
    public void setBlobFormat(gov.nih.nlm.ncbi.pubchem.BlobFormatType blobFormat) {
        this.blobFormat = blobFormat;
    }
     ...
     * @return eCompress
     */
    public gov.nih.nlm.ncbi.pubchem.CompressType getECompress() {
        return eCompress;
    }
     ...
     * @param eCompress
     */
    public void setECompress(gov.nih.nlm.ncbi.pubchem.CompressType eCompress) {
        this.eCompress = eCompress;
    }
